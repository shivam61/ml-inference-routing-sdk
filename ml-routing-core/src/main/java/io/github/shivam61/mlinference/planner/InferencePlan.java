...
public record InferencePlan(
    ...
    public record ExecutionStage(
        int stageNumber,
        List<io.github.shivam61.mlinference.domain.ModelDefinition> models
    ) {}
    ...
    public String explain() {
        ...
        Map<io.github.shivam61.mlinference.domain.BackendType, Long> backendCounts = stages.stream()
